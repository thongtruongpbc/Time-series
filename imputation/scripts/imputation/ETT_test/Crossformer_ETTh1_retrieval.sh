        ...
        do
            ...
            do
                ...
                python -u run.py \
                    ...
                    --retrieval_checkpoint_path "imputation/imputation_retriever/checkpoints_retriever/Transformer_ETTh1_mask_${rate}_ETTh1_ftM_sl${len}_ll0_pl0_dm16_nh8_el2_dl1_df32_expand2_dc4_fc3_ebtimeF_dtTrue_Exp_0/checkpoint.pth" \
