...
from layers.Transformer_EncDec import Decoder, DecoderLayer, Encoder, EncoderLayer, ConvLayer, CrossEncoderLayer
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.multihead_attn = nn.MultiheadAttention(configs.d_model, num_heads=1, dropout=0.2)
    ...
    def imputation(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask):
        ...
        enc_out, attns = self.encoder(enc_out, attn_mask=None)
        e_out, cls_out = enc_out[:, 1:, :], enc_out[:, 0, :]   # [B, L, d_model], [B, 1, d_model]
    ...
    def forward(self, x_enc, x_mark_enc, reference=None, x_dec=None, x_mark_dec=None, mask=None, training=1):
        ...
        if self.task_name == 'imputation':
            dec_out, cls_out = self.imputation(x_enc, x_mark_enc, x_dec, x_mark_dec, mask)
